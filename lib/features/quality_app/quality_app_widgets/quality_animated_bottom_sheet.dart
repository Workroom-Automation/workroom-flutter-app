...
class QualityAnimatedBottomSheet extends StatefulWidget {
  const QualityAnimatedBottomSheet({
    super.key,
  ...
  @override
  State<QualityAnimatedBottomSheet> createState() =>
      _QualityAnimatedBottomSheetState();
}

class _QualityAnimatedBottomSheetState extends State<QualityAnimatedBottomSheet>
